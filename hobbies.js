...
function show_craft() {
  document.getElementById("water-bottle").style.display = "block";
  document.getElementById("button-craft").style.display = "none";
}

function show_cooking_growing() {
  document.getElementById("cucumber").style.display = "block";
  document.getElementById("button_cooking_growing").style.display = "none";
  document.getElementById("strawb").style.display = "block";
  document.getElementById("button_cooking_growing").style.display = "none";
