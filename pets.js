...
const pets = [
  {
    ...
    likes:
      "playing in the park and chasing Leo with the ball. Belly rubs and cuddles",
    dislikes:
      "getting groomed and not being able to cuddle people who make eye contact with her",
  ...
  },
  {
    ...
    hobbies:
      "tennis balls for days! Cuddling up to people and giving no personal space",
  ...
  },
  {
    ...
    likes:
      "likes to lounge around all day in the sunshine, and eat her favourite snack - dreamies.",
    dislikes:
      "Anything loud and unfamiliar. Being told no. Any snacks not dreamies",
    hobbies:
      "Juniper likes to play string toys, eat food, and wake her pawrents up at 4am every morning.",
